...
class librarydetailForm extends Form
{
	protected $adapter;
    public function __construct(AdapterInterface $dbAdapter)
    {
        ...
        parent::__construct('librarydetail');
    ...
    public function getOptionsForSelect()
    {
    	...
    	$sql       = 'SELECT * FROM `librarybooks` WHERE 1';
    ...
    public function fetchAllCatalogue() {
    	...
    	$select->from ('librarydetail')
    	->join('librarybooks', 'librarydetail.idmz=librarybooks.id',array('id'=>'id','title'=>'title'));

...
namespace Appmincecraftrest\Controller;
...
class AppmincecraftrestController extends AbstractRestfulController
{
    ...
    {
    	//echo 'get list';
    	$results = $this->getRssgetTable()->fetch_All_Appmincecraftrest_Rest_Orderbyiddesc();
        $data = array();

  <li class="title">Menu</li>
                <li class="active"><a  href="<?php echo $this->url();  ?>">Home</a></li>
                <li><a  href="<?php echo $this->url() . '/index/magazinepublish';?>">Magazine</a></li>
                <li><a  href="<?php echo $this->url() . '/index/story';?>">Story</a></li>

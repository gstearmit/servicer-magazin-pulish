...
class PortcmsTable extends AbstractTableGateway {
    ...
    public function __construct(Adapter $adapter) {
        ...
        $this->resultSetPrototype->setArrayObjectPrototype(new Portcms());
   ...
   // public function fetchAllDetailstorydetail( $id , Select $select = null)
    ...
    public function getRestPortcms($id) {
    	$id = (int) $id;
...
//     	$sort[] = 'value ASC';
 //    	$select->order($sort);
    ...
    public function getReadPortcms($id)
    {
    	$id = (int) $id;
    ...
    public function savePortcms(Portcms $portcms) {
        $data = array(
            'descriptionkey' => $portcms->descriptionkey,
        	'imgkey' => $portcms->imgkey,
            'title' => $portcms->title,
        	'patient_id' => $portcms->patient_id,
    ...
    public function savePortcms2(Portcms $portcms) {
    ...
    public function deletePortcms($id) {

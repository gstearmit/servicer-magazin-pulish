<?php
namespace Uploadmagazinevietnam\Form;
...
class UploadmagazinevietnamForm extends Form
{  
    protected $adapter;
    public function __construct(AdapterInterface $dbAdapter)
    {
    	$this->adapter =$dbAdapter;
        parent::__construct('uploadmagazinevietnam');
    ...
    {
    	$dbAdapter = $this->adapter;
    	$sql       = 'SELECT * FROM magazinevietnam JOIN mgvndetail  ON magazinevietnam.id=mgvndetail.idmz';
    	$statement = $dbAdapter->query($sql);
    	$result    = $statement->execute();
